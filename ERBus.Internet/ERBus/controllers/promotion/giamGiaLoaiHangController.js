define(['ui-bootstrap', 'controllers/catalog/khoHangController', 'controllers/catalog/loaiHangController'], function () {
    ...
    /* controller list */
    app.controller('GiamGiaLoaiHang_Ctrl', ['$scope', '$http', 'configService', 'giamGiaLoaiHangService', 'tempDataService', '$filter', '$uibModal', '$log', 'securityService', 'khoHangService','loaiHangService','userService',
        function ($scope, $http, configService, service, tempDataService, $filter, $uibModal, $log, securityService, khoHangService, loaiHangService, userService) {
            ...
            function loadAccessList() {
                ...
                securityService.getAccessList('GiamGiaLoaiHang', userName, unitCodeParam).then(function (successRes) {
