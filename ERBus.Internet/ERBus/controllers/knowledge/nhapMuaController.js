define(['ui-bootstrap', 'controllers/catalog/nhaCungCapController', 'controllers/catalog/donViTinhController', 'controllers/catalog/thueController', 'controllers/authorize/thamSoHeThongController', 'controllers/catalog/khoHangController', 'controllers/authorize/kyKeToanController', 'controllers/catalog/matHangController', 'controllers/authorize/cuaHangController', 'controllers/authorize/thamSoHeThongController'], function () {
    ...
    app.controller('NhapMua_Ctrl', ['$scope', '$http', 'configService', 'nhapMuaService', 'tempDataService', '$filter', '$uibModal', '$log', 'securityService', 'nhaCungCapService', 'thueService', 'khoHangService','userService',
        function ($scope, $http, configService, service, tempDataService, $filter, $uibModal, $log, securityService, nhaCungCapService, thueService, khoHangService, userService) {
            ...
            $scope.title = function () { return 'Nhập hàng mua' };
            $scope.data = [];
            ...
            $scope.printItem = function (target) {
                var modalInstance = $uibModal.open({
                    ...
                    templateUrl: configService.buildUrl('knowledge/NhapMua', 'printItem'),
                    controller: 'nhapMuaPrintItemController',
                    resolve: {
                        targetData: function () {
                            return target;
                        }
            ...
            $scope.printItemShelves = function (target) {
                var modalInstance = $uibModal.open({
                    ...
                    animation: true,
                    windowClass: 'knowledge-window',
                    templateUrl: configService.buildUrl('knowledge/NhapMua', 'printItemShelves'),
                    controller: 'nhapMuaPrintItemShelvesController',
                    resolve: {
                        targetData: function () {
                            return target;
                        }
            ...
            $scope.create = function () {
                var modalInstance = $uibModal.open({
                    ...
                    animation: true,
                    windowClass: 'knowledge-window',
                    templateUrl: configService.buildUrl('knowledge/NhapMua', 'create'),
                    controller: 'nhapMuaCreate_Ctrl',
                    resolve: {}
                });
            ...
            $scope.detail = function (target) {
                var modalInstance = $uibModal.open({
                    ...
                    animation: true,
                    windowClass: 'knowledge-window',
                    templateUrl: configService.buildUrl('knowledge/NhapMua', 'detail'),
                    controller: 'nhapMuaDetail_Ctrl',
                    resolve: {
                        targetData: function () {
                            return target;
                        }
            ...
            $scope.approval = function (target) {
                var modalInstance = $uibModal.open({
                    ...
                    templateUrl: configService.buildUrl('knowledge/NhapMua', 'approval'),
                    controller: 'nhapMuaApproval_Ctrl',
                    resolve: {
                        targetData: function () {
                            return target;
                        }
            ...
            $scope.edit = function (target) {
                var modalInstance = $uibModal.open({
                    ...
                    animation: true,
                    windowClass: 'knowledge-window',
                    templateUrl: configService.buildUrl('knowledge/NhapMua', 'edit'),
                    controller: 'nhapMuaEdit_Ctrl',
                    resolve: {
                        targetData: function () {
                            return target;
                        }
            ...
            $scope.delete = function (event, target) {
                var modalInstance = $uibModal.open({
                    ...
                    templateUrl: configService.buildUrl('knowledge/NhapMua', 'delete'),
                    controller: 'nhapMuaDelete_Ctrl',
                    resolve: {
                        targetData: function () {
                            return target;
                        }
    ...
    app.controller('nhapMuaPrintItemController', ['$scope', '$uibModalInstance', '$http', 'configService', 'nhapMuaService', 'tempDataService', '$filter', '$uibModal', '$log', 'targetData', '$window',
    ...
    app.controller('nhapMuaPrintItemShelvesController', ['$scope', '$uibModalInstance', '$http', 'configService', 'nhapMuaService', 'tempDataService', '$filter', '$uibModal', '$log', 'targetData', '$window',
       function ($scope, $uibModalInstance, $http, configService, service, tempDataService, $filter, $uibModal, $log, targetData, $window) {
           $scope.config = angular.copy(configService);
    ...
    function ($scope, $uibModalInstance, $http, configService, service, tempDataService, $filter, $uibModal, $log, nhaCungCapService, donViTinhService, thueService, khoHangService, kyKeToanService, matHangService, userService, thamSoHeThongService) {
        ...
        $scope.exportData = [];
        // Prepare Excel data:
        $scope.fileName = "NhapMuaExport_" + $scope.target.MA_CHUNGTU;
        //end
    ...
    app.controller('nhapMuaDetail_Ctrl', ['$scope', '$uibModalInstance', '$http', 'configService', 'nhapMuaService', 'targetData', 'tempDataService', '$filter', '$uibModal', '$log', 'thueService',
        function ($scope, $uibModalInstance, $http, configService, service, targetData, tempDataService, $filter, $uibModal, $log, thueService) {
            ...
            $scope.exportData = [];
            // Prepare Excel data:
            $scope.fileName = "NhapMuaExport_" + targetData.MA_CHUNGTU;
            $scope.exportData.push(["STT", "MAHANG", "TENHANG", "MADONVITINH", "MATHUE_VAO", "TYLE_LAILE", "SOLUONG", "GIAMUA", "GIAMUA_VAT", "TIEN_GIAMGIA", "THANHTIEN", "THANHTIEN_VAT"]);
            //end
    ...
    app.controller('nhapMuaApproval_Ctrl', ['$scope', '$uibModalInstance', '$http', 'configService', 'nhapMuaService', 'targetData', 'tempDataService', '$filter', '$uibModal', '$log', 'thueService', 'donViTinhService', 'userService', 'nhaCungCapService', 'cuaHangService', 'kyKeToanService', '$mdDialog',
    ...
    app.controller('nhapMuaEdit_Ctrl', ['$scope', '$uibModalInstance', '$http', 'configService', 'nhapMuaService', 'targetData', 'tempDataService', '$filter', '$uibModal', '$log', 'thueService', 'matHangService', 'userService',
    ...
    app.controller('nhapMuaDelete_Ctrl', ['$scope', '$uibModalInstance', '$http', 'configService', 'nhapMuaService', 'targetData', 'tempDataService', '$filter', '$uibModal', '$log',
