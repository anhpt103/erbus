define(['ui-bootstrap', 'controllers/catalog/khachHangController', 'controllers/catalog/donViTinhController', 'controllers/catalog/thueController', 'controllers/authorize/thamSoHeThongController', 'controllers/catalog/khoHangController', 'controllers/catalog/matHangController'], function () {
    ...
    /* controller list */
    app.controller('XuatBanLeThuNgan_Ctrl', ['$scope', '$http', 'configService', 'xuatBanLeThuNganService', 'tempDataService', '$filter', '$uibModal', '$log', 'securityService', 'khachHangService', 'thueService', 'khoHangService','donViTinhService','userService',
        function ($scope, $http, configService, service, tempDataService, $filter, $uibModal, $log, securityService, khachHangService, thueService, khoHangService, donViTinhService, userService) {
            ...
            function loadAccessList() {
                ...
                securityService.getAccessList('XuatBanLeThuNgan', userName, unitCodeParam).then(function (successRes) {
