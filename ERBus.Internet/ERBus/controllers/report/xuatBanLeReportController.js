define(['ui-bootstrap', 'controllers/catalog/khoHangController', 'controllers/catalog/loaiHangController', 'controllers/catalog/nhomHangController', 'controllers/catalog/nhaCungCapController', 'controllers/catalog/matHangController', 'controllers/authorize/cuaHangController', 'controllers/authorize/authController', 'controllers/authorize/kyKeToanController'], function () {
    'use strict';
    var app = angular.module('xuatBanLeModule', ['ui.bootstrap', 'khoHangModule', 'loaiHangModule', 'nhomHangModule', 'nhaCungCapModule', 'matHangModule', 'cuaHangModule', 'kyKeToanModule']);
    app.factory('xuatBanLeService', ['$http', 'configService', function ($http, configService) {
    ...
    /* controller list */
    app.controller('BaoCaoXuatBanLe_Ctrl', ['$scope', '$http', 'configService', 'xuatBanLeService', 'tempDataService', '$filter', '$uibModal', '$log', 'securityService', 'khoHangService', 'loaiHangService', 'nhomHangService', 'nhaCungCapService', 'matHangService', 'cuaHangService', 'userService', 'kyKeToanService',
