define(['ui-bootstrap'], function () {
    ...
    /* controller list */
    app.controller('KeHang_Ctrl', ['$scope', '$http', 'configService', 'keHangService', 'tempDataService', '$filter', '$uibModal', '$log', 'securityService','userService',
        function ($scope, $http, configService, service, tempDataService, $filter, $uibModal, $log, securityService, userService) {
            ...
            function loadAccessList() {
                ...
                securityService.getAccessList('KeHang', userName, unitCodeParam).then(function (successRes) {
