define(['ui-bootstrap'], function () {
    ...
    /* controller list */
    app.controller('KhoHang_Ctrl', ['$scope', '$http', 'configService', 'khoHangService', 'tempDataService', '$filter', '$uibModal', '$log', 'securityService','userService',
        function ($scope, $http, configService, service, tempDataService, $filter, $uibModal, $log, securityService, userService) {
            ...
            function loadAccessList() {
                ...
                securityService.getAccessList('KhoHang', userName, unitCodeParam).then(function (successRes) {
