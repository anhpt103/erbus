define(['ui-bootstrap'], function () {
    ...
    /* controller list */
    app.controller('KhachHang_Ctrl', ['$scope', '$http', 'configService', 'khachHangService', 'tempDataService', '$filter', '$uibModal', '$log', 'securityService','userService',
        function ($scope, $http, configService, service, tempDataService, $filter, $uibModal, $log, securityService, userService) {
            ...
            function loadAccessList() {
                ...
                securityService.getAccessList('KhachHang', userName, unitCodeParam).then(function (successRes) {
