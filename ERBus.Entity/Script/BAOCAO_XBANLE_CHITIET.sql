...
BEGIN
   ...
   (
    ...
    END;
  BEGIN
        QUERY_STR := 'SELECT MACHA, TENCHA, BARCODE, MACON, TENCON, NGAY_GIAODICH, GROUP_CODE, SOLUONG,GIAVON,VON,VON_VAT,TIEN_CHIETKHAU,TIEN_KHUYENMAI,TIENTHE_VIP,DOANHTHU,TIENTHUE,LAIBANLE,DOANHTHU + TIENTHUE AS TONGBAN,GIABANLE_VAT
        FROM
        (
